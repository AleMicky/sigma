...
@Tag(name = "Checklists de Mantenimiento", description = "Administración de checklists de actividades de mantenimiento")
...
public class ChecklistMantenimientoController {
        ...
        public ResponseEntity<ApiResponse<PageResponse<ChecklistMantenimientoResponse>>> findAll(
                        @RequestParam(required = false) String q,
                        @Valid @ModelAttribute PageRequestDto pageRequest) {
                return ResponseEntity.ok(
                                ApiResponse.success(
