...
@Tag(name = "Documentos", description = "Administración de documentos de activos")
@SecurityRequirement(name = OpenApiConfig.SECURITY_SCHEME_NAME)
public class DocumentosController
                extends AbstractCrudController<DocumentosRequest, DocumentosResponse, UUID> {

        private final DocumentosService documentosService;

        @Override
        protected CrudService<DocumentosRequest, DocumentosResponse, UUID> service() {
