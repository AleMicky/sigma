...
@Tag(name = "Evidencias de Actividades de Orden de Trabajo", description = "Administración de evidencias (archivos) de actividades de órdenes de trabajo")
...
public class OrdenTrabajoActividadEvidenciaController {
        ...
        @Operation(summary = "Subir una evidencia a una actividad de orden de trabajo")
        ...
        @Operation(summary = "Reemplazar el archivo de una evidencia existente")
        ...
        public ResponseEntity<ApiResponse<PageResponse<OrdenTrabajoActividadEvidenciaResponse>>> findByOrdenTrabajoActividadId(
                ...
                return ResponseEntity.ok(
                                ApiResponse.success(
                                                service.findByOrdenTrabajoActividadId(ordenTrabajoActividadId,
                                                                pageRequest)));
        }
