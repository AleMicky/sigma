...
@Repository
public interface SpringOrdenTrabajoActividadEvidenciaRepository
        extends JpaRepository<OrdenTrabajoActividadEvidenciaEntity, UUID> {

    Page<OrdenTrabajoActividadEvidenciaEntity> findByOrdenTrabajoActividadId(
