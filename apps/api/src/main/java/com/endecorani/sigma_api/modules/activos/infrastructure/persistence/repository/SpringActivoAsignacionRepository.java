...
@Repository
public interface SpringActivoAsignacionRepository
        extends BaseJpaRepository<ActivoAsignacionEntity, UUID>, JpaSpecificationExecutor<ActivoAsignacionEntity> {
}
