...
@Tag(name = "Adjuntos de Solicitudes de Mantenimiento", description = "Administración de adjuntos de solicitudes de mantenimiento")
...
public class SolicitudMantenimientoAdjuntoController {
        ...
        @Operation(summary = "Registrar un adjunto con su archivo en una solicitud de mantenimiento")
        public ResponseEntity<ApiResponse<SolicitudMantenimientoAdjuntoResponse>> createWithFile(
                        @PathVariable UUID solicitudMantenimientoId,
                        @RequestPart("file") MultipartFile file,
                        @RequestPart(value = "data", required = false) SolicitudMantenimientoAdjuntoRequest request) {
        ...
        public ResponseEntity<ApiResponse<SolicitudMantenimientoAdjuntoResponse>> replaceFile(
        ...
        public ResponseEntity<ApiResponse<SolicitudMantenimientoAdjuntoResponse>> findById(
                        @PathVariable UUID id) {
                return ResponseEntity.ok(
        ...
        @GetMapping
        @Operation(summary = "Listar adjuntos de una solicitud de mantenimiento")
        public ResponseEntity<ApiResponse<PageResponse<SolicitudMantenimientoAdjuntoResponse>>> findBySolicitudMantenimientoId(
                        @PathVariable UUID solicitudMantenimientoId,
        ...
        @DeleteMapping("/{id}")
        @Operation(summary = "Eliminar un adjunto de una solicitud de mantenimiento")
