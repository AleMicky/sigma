...
@Table(
        ...
        indexes = {
                @Index(name = "idx_solicitud_mantenimiento_activo",
                        columnList = "activo_id"),
                @Index(name = "idx_solicitud_mantenimiento_estado",
                        columnList = "estado"),
                @Index(name = "idx_solicitud_mantenimiento_solicitante",
                        columnList = "solicitante_id"),
                @Index(name = "idx_solicitud_mantenimiento_responsable",
                        columnList = "responsable_id"),
                @Index(name = "idx_solicitud_mantenimiento_fecha",
