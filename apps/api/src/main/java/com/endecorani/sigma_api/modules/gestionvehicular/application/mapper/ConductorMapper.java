...
public interface ConductorMapper {
    ...
    @Mapping(target = "numeroLicencia", source = "domain.numeroLicencia")
    @Mapping(target = "categoriaLicencia", source = "domain.categoriaLicencia")
    @Mapping(target = "fechaVencimiento", source = "domain.fechaVencimiento")
