...
@Tag(name = "Componentes", description = "Administración de componentes por tipo de activo")
@SecurityRequirement(name = OpenApiConfig.SECURITY_SCHEME_NAME)
public class ComponenteController
                extends AbstractCrudController<ComponenteRequest, ComponenteResponse, UUID> {

        private final ComponenteService componenteService;

        @Override
        protected CrudService<ComponenteRequest, ComponenteResponse, UUID> service() {
