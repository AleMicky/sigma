...
const RESUMEN_CARDS: ResumenCardConfig[] = [
  ...
  },
  {
    ...
    activeClass: "border-purple-500/60 bg-gradient-to-br from-purple-500/15 via-purple-500/5 to-transparent ring-1 ring-purple-500/30 shadow-xs",
    indicatorClass: "bg-purple-500 shadow-xs shadow-purple-500/50",
    hoverBorderClass: "hover:border-purple-500/40",
    hoverBgClass: "hover:bg-purple-500/[0.04]",
    iconActiveClass: "bg-purple-600 text-white shadow-sm shadow-purple-600/30",
    iconInactiveClass: "bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20",
