...
import { Calendar, Check, Clock, Copy, FileText, ShieldCheck, User } from "lucide-react"
  ...
  return (
    <div className="w-full rounded-2xl border border-border/80 bg-card divide-y divide-border/40 overflow-hidden shadow-2xs">
                ...
                <div className="flex flex-col min-w-0 flex-1 gap-1">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {tipo.requiereVencimiento ? (
                      <Badge
                        variant="secondary"
                        className="gap-1 text-[11px] font-medium bg-amber-500/10 text-amber-700 dark:text-amber-400 border-amber-500/20"
                      >
                      ...
                      <Badge
                        variant="secondary"
                        className="gap-1 text-[11px] font-medium bg-muted text-muted-foreground border-border/50"
                      >
      ...
      <ConfirmDeleteDialog
        ...
        description={
          tipoToDelete
            ? `¿Seguro que deseas eliminar "${tipoToDelete.nombre}"? Esta acción no se puede deshacer.`
