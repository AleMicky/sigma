...
interface ActivoCatalogoListViewProps {
  activos: Activo[]
  tiposById: Map<string, TipoActivo>
  ubicacionesById: Map<string, Ubicacion>
}

export function ActivoCatalogoListView({
  activos,
  tiposById,
  ubicacionesById,
}: ActivoCatalogoListViewProps) {
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-4">
              <div className="flex items-start gap-3 sm:gap-4 min-w-0 flex-1">
                {/* Thumbnail con formato panorámico panorámico/apaisado para vehículos y maquinaria */}
                <Link
                  ...
                  title={`Ver ficha técnica de ${activo.nombre}`}
                >
                  <AuthenticatedImage
