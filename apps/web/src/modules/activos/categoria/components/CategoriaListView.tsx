...
type CategoriaListViewProps = {
  categorias: Categoria[]
  onEdit: (categoria: Categoria) => void
}

export function CategoriaListView({
  categorias,
  onEdit,
}: CategoriaListViewProps) {
  ...
  function copyCode(e: React.MouseEvent, categoria: Categoria) {
    e.stopPropagation()
  ...
  return (
    <div className="w-full rounded-2xl border border-border/80 bg-card divide-y divide-border/40 overflow-hidden shadow-2xs">
              ...
              <div className="flex items-start gap-3.5 min-w-0 flex-1">
                ...
                <div className="flex flex-col min-w-0 flex-1 gap-1">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {typeof categoria.orden === "number" && (
                      <Badge
                        variant="secondary"
                        className="gap-1 text-[11px] font-medium font-mono"
                      >
      ...
      <ConfirmDeleteDialog
        ...
        description={
          categoriaToDelete
            ? `¿Seguro que deseas eliminar "${categoriaToDelete.nombre}"? Esta acción no se puede deshacer.`
