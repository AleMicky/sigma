...
type SolicitudVehicularNonEditableAlertProps = {
  estado?: string | null
}

export function SolicitudVehicularNonEditableAlert({
  estado,
}: SolicitudVehicularNonEditableAlertProps) {
  return (
      ...
      <div className="flex max-w-md flex-col items-center text-center gap-4 p-6 rounded-2xl border bg-card shadow-sm">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            se pueden modificar solicitudes en estado <strong>Pendiente</strong>, <strong>Borrador</strong> u{" "}
