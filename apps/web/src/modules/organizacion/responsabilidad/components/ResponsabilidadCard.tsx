...
export function ResponsabilidadCard({
  ...
  return (
    <li className="group flex min-w-0 flex-col justify-between gap-2.5 rounded-xl border border-border bg-card p-3 shadow-2xs transition-all hover:border-primary/40 hover:shadow-xs sm:gap-3 sm:p-4">
